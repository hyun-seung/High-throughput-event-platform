...
**1차 PoC는 앞당겨 진행:** [구간별 검증 계획](13-1차-성능-PoC-구간별-검증-계획.md)의 시작 조건이 갖춰지면 HTTP 1차 접수 경로부터 측정합니다. TCP 2차·전체 후속 기능·Kubernetes 완성을 기다리지 않습니다. 2026-09-24 첫 측정에서 10·50 TPS는 통과했고 100 TPS는 적체 증가로 중단했습니다. [결과와 다음 실험](16-1차-성능-PoC-측정-결과.md)에 범위·수치·한계를 기록했습니다.
