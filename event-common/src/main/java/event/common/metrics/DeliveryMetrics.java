...
public final class DeliveryMetrics {
    public enum Stage { API_PUBLISH, INGRESS_PROCESS, INGRESS_STORE, INGRESS_PUBLISH,
        DISPATCH_PROCESS, DISPATCH_CLAIM, DISPATCH_HTTP, DISPATCH_TCP, DISPATCH_STORE, RECEIPT_PUBLISH, RECEIPT_PROCESS }
    public enum Outcome { INGRESS_FORWARDED, INGRESS_DLT, INGRESS_DLT_FAILED,
        ...
        DISPATCH_RETRY_SCHEDULED, DISPATCH_RETRY_WAIT, DISPATCH_DECISION_PENDING, SECONDARY_ACCEPTED,
        RECEIPT_DELIVERED, RECEIPT_LATE_DISCARDED, RECEIPT_STALE_DISCARDED, RECEIPT_DUPLICATE, RECEIPT_DECISION_STORED }
